...
QT_MOC_LITERAL(1, 13, 4), // "over"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "RecordThread\0over\0"
};
...
void RecordThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (RecordThread::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RecordThread::over)) {
                *result = 0;
                return;
            }
        }
